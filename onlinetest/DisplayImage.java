...
public class DisplayImage extends JFrame {
    ...
    public DisplayImage() {
		try {
                        ...
                        Font customFont = Font.createFont(Font.TRUETYPE_FONT, new File("C:\\onlinetest\\font\\Cabin-Bold.otf")).deriveFont(12f);
                        GraphicsEnvironment ge = GraphicsEnvironment.getLocalGraphicsEnvironment();
                        //register the font
                        ge.registerFont(Font.createFont(Font.TRUETYPE_FONT, new File("C:\\onlinetest\\font\\Cabin-Bold.otf")));
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
					...
					try {
                        //create the font to use. Specify the size!
                        Font customFont = Font.createFont(Font.TRUETYPE_FONT, new File("C:\\onlinetest\\font\\Cabin-BoldItalic.otf")).deriveFont(12f);
                        GraphicsEnvironment ge = GraphicsEnvironment.getLocalGraphicsEnvironment();
                        //register the font
                        ge.registerFont(Font.createFont(Font.TRUETYPE_FONT, new File("C:\\onlinetest\\font\\Cabin-BoldItalic.otf")));
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                    catch(FontFormatException e)
					...
					try {
                        //create the font to use. Specify the size!
                        Font customFont = Font.createFont(Font.TRUETYPE_FONT, new File("C:\\onlinetest\\font\\Cabin-Italic.otf")).deriveFont(12f);
                        GraphicsEnvironment ge = GraphicsEnvironment.getLocalGraphicsEnvironment();
                        //register the font
                        ge.registerFont(Font.createFont(Font.TRUETYPE_FONT, new File("C:\\onlinetest\\font\\Cabin-Italic.otf")));
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                    catch(FontFormatException e)
 	...
 	frame.setUndecorated(true);
		...
		frame.setSize(10000,10000);
		 ...
		 //blogin.setMargin(new Insets(4,4,4,4));
        ...
        label.setIcon(new ImageIcon("C:\\onlinetest\\zefset4.png"));// your image here
...
try{
 ...
 PrintWriter writer = new PrintWriter("C:\\onlinetest\\result.txt", "UTF-8");
     //bw.write("\n\nOTP entered : "+ppaswd);
	 writer.println("\n\nStudent Name: "+puname);
	 writer.println("\n");
	 writer.println("\n");
...
catch(Exception e){//System.out.println("Error in writing marks to file");
		}
...
BufferedWriter bw = null;
      ...
      try {
        ...
        bw = new BufferedWriter(new FileWriter("C:\\onlinetest\\result.txt", true));
		// PrintWriter writer = new PrintWriter("C:\\onlinetest\\result.txt", "UTF-8");
     bw.write("\n\nOTP entered : "+ppaswd);
	 //writer.println("\n\nOTP entered : "+ppaswd);
	 //writer.println("\n");
	 ...
	 bw.newLine();
	 bw.newLine();
	 //bw.write("Student Roll No. : "+ppaswd);
	 String timeStamp = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new java.util.Date());
...
txuser.setBounds(90,30,150,20);
//pass.setBounds(90,70,150,20);
//blogin.setBounds(110,130,80,20);
...
try{
 ...
 PrintWriter writer = new PrintWriter("C:\\onlinetest\\beares.txt", "UTF-8");
...
static String testtitle="ZefSET Online Attitude Test";
...
class Centerwindow extends JPanel{
	...
	public Centerwindow(){
       ...
       pane.setText("ZefSET Online Attitude Test");
...
northEast.setFont(new Font ("customFont",Font.BOLD,16) );		
		...
		//centerEast.setBackground(Color.black);
...
/* record answer method */
	...
	public void recordanswer(){
		...
		//for(int j=0; j<boxes.length; j++)boxes[j]
    }
...
int j,i;
		...
		try{
			...
			FileReader fr = new FileReader("C:\\onlinetest\\beares.txt");
...
fr.close();
 ...
 bw.write((x+1)+" :\t "+choice[x]+"\t "+QuestionSeries.choice[x]);
     ...
     bw.write("\n\nNo. of unattempted questions : "+counter);
		bw.newLine();
//for(int k=0;k<j;k++){System.out.println(incorrect[k]);bw.write(incorrect[k]);bw.newLine();}
...
class Resultwindow extends JFrame{
	...
	panel.setBackground(Color.white);		
        JLabel label = new JLabel();
        label.setIcon(new ImageIcon("C:\\onlinetest\\THANX.png"));// your image here
...
JLabel label = new JLabel();
        label.setIcon(new ImageIcon("C:\\onlinetest\\di.png"));
		label.setVerticalAlignment(JLabel.CENTER);
		label.setHorizontalAlignment(JLabel.CENTER);
panel.add(label);
getContentPane().add(panel);
...
JLabel label = new JLabel();
        label.setIcon(new ImageIcon("C:\\onlinetest\\q2.png"));
		label.setVerticalAlignment(JLabel.CENTER);
		label.setHorizontalAlignment(JLabel.CENTER);
panel.add(label);
getContentPane().add(panel);
